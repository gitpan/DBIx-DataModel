...
Each application class has a I<metaclass>, i.e. an object 
of a class in the C<DBIx::DataModel::Meta> namespace.
...
even to change their behaviour. See L<TODO:MORE_DOC_ON_METACLASSES>.
...
data source, and to yield either immediate data rows or some intermediate
