...
For each path, an method of the same name is also added into 
the appropriate table class.

=item * 

If the association is also a I<composition>, a method
method C<insert_into_$path> is added into the composite class.

=back



[TODO : REWORK THE WHOLE SECTION. Below are some bits
remaining from previous documentation]
